...
SYSTEM_PROMPT = (
    ...
    "next to that fact. Reproduce the citation text attached to the "
    "retrieved chunk exactly as given, character for character, "
    "including its full URL — do not shorten it, reformat it, drop the "
    "URL, or replace it with your own paraphrase like 'see file.py lines "
    "X-Y'. If you cannot see a citation attached to a chunk, do not "
    "invent one — even if the question's main topic is something "
